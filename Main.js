...
(function(exports) {
      ...
      return function (f) {
          return function (sep) {
              var go = function (v) {
                  ...
                  throw new Error("Failed pattern match at Web line 221, column 1 - line 222, column 1: " + [ v.constructor.name ]);
              };
              return go;
          };
      };
  ...
  var getPath = function (j) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Web line 32, column 1 - line 33, column 1: " + [ $150.constructor.name ]);
      };
  };
  ...
  var atom = function (v) {
      return function (t) {
          return function (i) {
              ...
              throw new Error("Failed pattern match at Web line 112, column 1 - line 113, column 1: " + [ v.constructor.name, t.constructor.name, i.constructor.name ]);
          };
      };
  };
  var binary = function (op) {
              ...
              return Control_Bind["=<<"](Control_Monad_Eff.bindEff)(function (jObj) {
                  ...
                  return function __do() {
                      ...
                      (function () {
                          ...
                          throw new Error("Failed pattern match at Web line 60, column 1 - line 61, column 1: " + [ v1.constructor.name ]);
                      })()();
                      return jObj;
                  };
              })((function () {
                  ...
                  if (o.expr instanceof AST.List && (o.typ instanceof AST.TListTree && o.idTree instanceof AST.IListTree)) {
                      ...
                      throw new Error("Failed pattern match at Web line 60, column 1 - line 61, column 1: " + [ $403.constructor.name ]);
                  };
...
(function(exports) {
  ...
  var displayEvalError = function (err) {
      return function (jq) {
          ...
          if (err instanceof Evaluator.NoMatchingFunction) {
              ...
              throw new Error("Failed pattern match at Main line 185, column 1 - line 186, column 1: " + [ $48.constructor.name ]);
          };
          return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
      };
  };
                      ...
                      return function __do() {
                          ...
                          if (v instanceof Data_Maybe.Just) {
                              ...
                              if ($53 instanceof Data_Either.Right) {
                                  ...
                                  throw new Error("Failed pattern match at Main line 173, column 3 - line 174, column 3: " + [ $55.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Main line 173, column 3 - line 174, column 3: " + [ $53.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main line 173, column 3 - line 174, column 3: " + [ v.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var outIfErr = function (origin) {
      return function (either) {
          ...
          throw new Error("Failed pattern match at Main line 67, column 1 - line 68, column 1: " + [ either.constructor.name ]);
      };
  };
              ...
              return function (jq1) {
                  return function __do() {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          ...
                          throw new Error("Failed pattern match at Main line 212, column 3 - line 213, column 3: " + [ $106.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main line 212, column 3 - line 213, column 3: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var startEvaluation = function __do() {
      ...
      if ($112 instanceof Data_Either.Right) {
          ...
          if ($114 instanceof Data_Either.Right) {
              ...
              throw new Error("Failed pattern match at Main line 44, column 1 - line 45, column 1: " + [ $121.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 44, column 1 - line 45, column 1: " + [ $114.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main line 44, column 1 - line 45, column 1: " + [ $112.constructor.name ]);
  };
  var main = Control_Monad_Eff_JQuery.ready(function __do() {
      Prelude[">>="](Control_Monad_Eff.bindEff)(Prelude[">>="](Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#input"))(Control_Monad_Eff_JQuery.on("change")(function (v) {
          ...
          return function (v) {
              ...
              throw new Error("Failed pattern match at Main line 31, column 1 - line 32, column 1: " + [ $130.constructor.name ]);
          };
      }))();
      return startEvaluation();
  });
